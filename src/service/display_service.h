...
enum class InteractiveView {
    EYES_NORMAL = VIEW_EYES_NORMAL,
    EYES_SQUISH = VIEW_EYES_SQUISH,
    CODE_VIEW = VIEW_CODE,
    DRAW = VIEW_DRAW,
    THINKING = VIEW_THINKING,
    WORKING = VIEW_WORKING,
    CLOCK = VIEW_CLOCK,
    ...
    MARKET = VIEW_MARKET,
    DINO_GAME = VIEW_DINO,
    SOKOBAN_GAME = VIEW_SOKOBAN,
    TETRIS_GAME = VIEW_TETRIS,
    SNAKE_GAME = VIEW_SNAKE,
    GAME_2048 = VIEW_2048,
    BREAKOUT_GAME = VIEW_BREAKOUT,
    SALARY_COUNTER = VIEW_SALARY,
    TIMETABLE = VIEW_TIMETABLE,
    MEDIA = VIEW_MEDIA,
    USAGE = VIEW_USAGE,
    DESKTOP_STREAM = VIEW_DESKTOP_STREAM,
    KEYBOARD_PET = VIEW_KEYBOARD_PET
};
