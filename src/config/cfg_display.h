...
#define VIEW_USAGE      20
#define VIEW_DESKTOP_STREAM 21
#define VIEW_KEYBOARD_PET 22
// 新增可轮播页面时只需把 VIEW_* 加入这里，并实现对应页面渲染。
#define CAROUSEL_MAX_VIEW_COUNT 12
#define CAROUSEL_SUPPORTED_VIEW_COUNT 8
static constexpr uint8_t CAROUSEL_SUPPORTED_VIEW_IDS[
    CAROUSEL_SUPPORTED_VIEW_COUNT] = {
        VIEW_CLOCK, VIEW_POMODORO, VIEW_WEATHER, VIEW_CRYPTO,
        VIEW_MARKET, VIEW_SALARY, VIEW_TIMETABLE, VIEW_USAGE
    };
